package com.example.memotodo.views;
...
/*
* 1.input_icon:表示输入框前的小图标
* 2.input_hint:输入框提示的内容
* 3.is_password:输入的内容是否需要以密文的形式展现* */
...
//        获取自定义属性
        ...
        inputIcon = typedArray.getResourceId(R.styleable.InputView_input_icon, R.mipmap.welcomepic);
