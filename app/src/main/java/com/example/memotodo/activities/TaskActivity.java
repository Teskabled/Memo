...
public class TaskActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SpUtils.getStatus()){
            startActivity(new Intent(this,TemporaryTaskActivity.class));
            finish();
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add("预设").setIcon(R.mipmap.ic_menu_settings).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                new AlertDialog.Builder(TaskActivity.this).setItems(new String[]{"默认模式","调试用"}, new DialogInterface.OnClickListener() {
                    @Override
        ...
        menu.add("添加").setIcon(R.mipmap.ic_menu_add).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                onAddClick(null);
                return true;
        ...
        menu.add("开始").setIcon(R.mipmap.ic_menu_start).setShowAsActionFlags(MenuItem.SHOW_AS_ACTION_ALWAYS).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if(mAdapter.getCount()<1){
                    Toast.makeText(TaskActivity.this, "没有添加事件条目。", Toast.LENGTH_SHORT).show();
                    return true;
                }
                new AlertDialog.Builder(TaskActivity.this).setTitle("启动番茄钟").setMessage("是否启动番茄钟?")
                        .setPositiveButton("是的", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                SpUtils.setStatus(true);
                                SpUtils.setStartTime(System.currentTimeMillis());
                                startActivity(new Intent(TaskActivity.this,TemporaryTaskActivity.class));
                                finish();
                            }
    ...
    class TimeEntryAdapter extends ArrayAdapter<TimeEntry>{
        ...
        public TimeEntryAdapter(List<TimeEntry> objects) {
            super(TaskActivity.this, R.layout.adapter_time_entry,R.id.txtItemText, objects);
        }
            ...
            btnConfirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(TextUtils.isEmpty(txtDescription.getText())){
                        Toast.makeText(TaskActivity.this, "请输入时间段说明", Toast.LENGTH_SHORT).show();
