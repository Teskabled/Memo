...
import com.example.memotodo.utils.TimeOutReceiver;
import java.util.Date;
import java.util.List;

public class TemporaryTaskActivity extends BaseActivity {

    public static TemporaryTaskActivity mInstance = null;

    FrameLayout activity_temporary_task = null;
    ...
    void initUi(){
        activity_temporary_task = findViewById(R.id.activity_temporary_task);
        clockBackground = findViewById(R.id.clockBackground);
        progressTime = findViewById(R.id.progressTime);
        txtClockTime = findViewById(R.id.txtClockTime);
        txtClockDescription = findViewById(R.id.txtClockDescription);
    }
        ...
        new AlertDialog.Builder(this).setTitle("停止番茄钟").setMessage("是否停止番茄钟?")
                .setPositiveButton("是的", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        PendingIntent pendingIntent = PendingIntent.getBroadcast(TemporaryTaskActivity.this, 0, new Intent(TemporaryTaskActivity.this, TimeOutReceiver.class), 0);
                        AlarmManager.AlarmClockInfo next = alarmManager.getNextAlarmClock();
                        if (null != next) {
                            alarmManager.cancel(pendingIntent);
                        }
                        startActivity(new Intent(TemporaryTaskActivity.this,TaskActivity.class));
                        finish();
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInstance = this;
        setContentView(R.layout.activity_temporary_task);
        initUi();
    ...
    public void requireNotification(){
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .setSmallIcon(R.mipmap.ic_stat_clock)  //设置小图标  只能使用alpha图层的图片进行设置
